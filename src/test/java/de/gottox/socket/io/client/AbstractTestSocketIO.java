...
import de.gottox.socket.io.client.utils.MutateProxy;

// TODO: Auto-generated Javadoc
/**
 * The Class AbstractTestSocketIO.
 */
@RunWith(de.gottox.socket.io.client.utils.RandomBlockJUnit4ClassRunner.class)
public abstract class AbstractTestSocketIO implements IOCallback {
	...
	public void setUp() throws Exception {
		...
		node = Runtime.getRuntime().exec(
				new String[] { NODE, "./src/test/java/de/gottox/socket/io/client/utils/socketio.js",
						"" + getPort(), transport });
